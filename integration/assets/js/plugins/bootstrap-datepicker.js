...
(function (factory) {
    ...
    fill: function () {
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        html.push(
            ...
            + tooltip + '"' : '') + (this.o.dateCells ? ' data-date="'
            + prevMonth.getTime().toString() + '"' : '') + '><div>'
            + prevMonth.getUTCDate() + '</div></td>');
        tooltip = null;
  ...
  var datepickerPlugin = function (option) {
    ...
    if (this.length > 1) {
      throw new Error(
          'Using only allowed for the collection of a single element (' + option
          + ' function)');
    } else {
