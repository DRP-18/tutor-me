...
(function (global, factory) {
  ...
  function assertType(value, type, vm) {
    ...
    if (simpleCheckRE.test(expectedType)) {
      ...
      try {
        ...
        warn('Invalid prop type: "' + String(type) + '" is not a constructor',
            vm);
        valid = false;
      }
    }
  ...
  function renderSlot(
    ...
    if (scopedSlotFn) {
      ...
      nodes =
          scopedSlotFn(props) ||
          (typeof fallbackRender === 'function' ? fallbackRender()
              : fallbackRender);
    } else {
      nodes =
          this.$slots[name] ||
  ...
  function parse(
    ...
    maybeComponent = function (el) {
      return !!(
          ...
          !(el.attrsMap.is ? isReservedTag(el.attrsMap.is) : isReservedTag(
              el.tag))
      );
    };
  ...
  function generate(
    ...
    var code = ast ? (ast.tag === 'script' ? 'null' : genElement(ast, state))
        : '_c("div")';
    return {
