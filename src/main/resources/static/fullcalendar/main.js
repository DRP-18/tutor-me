...
var FullCalendar = (function (exports) {
  ...
  function a$1(n, l, u) {
    ...
    for (o in l) {
      "key" == o ? i = l[o] : "ref" == o ? t = l[o]
          : f[o] = l[o];
    }
    if (arguments.length > 3) {
      for (u = [u], o = 3; o < arguments.length;
          o++) {
        u.push(r[o]);
      }
    }
    if (null != u && (f.children = u), "function" == typeof n && null
    != n.defaultProps) {
      for (o in n.defaultProps) {
        void 0 === f[o]
        && (f[o] = n.defaultProps[o]);
      }
    }
  ...
  function _(n) {
    ...
    if (null != (n = n.__) && null != n.__c) {
      for (n.__e = n.__c.base = null, l = 0; l < n.__k.length;
          l++) {
  ...
  function k(l) {
    (!l.__d && (l.__d = !0) && u.push(l) && !b$1.__r++ || t
        !== n.debounceRendering) && ((t = n.debounceRendering) || i$1)(b$1);
  }
  ...
  function b$1() {
    for (var n; b$1.__r = u.length;) {
      n = u.sort(function (n, l) {
        ...
        var l, u, i, t, o, r;
        n.__d && (o = (t = (l = n).__v).__e, (r = l.__P)
        && (u = [], (i = c$1({}, t)).__v = t.__v + 1, I$1(r, t, i, l.__n,
            void 0 !== r.ownerSVGElement, null != t.__h ? [o] : null, u,
            null == o ? d(t) : o, t.__h), T$1(u, t), t.__e != o && _(t)));
      });
    }
  }
  ...
  function m(n, l, u, i, t, o, e, c, s, a) {
    ...
    for (u.__k = [], h = 0; h < l.length; h++) {
      if (null
          != (k = u.__k[h] = null == (k = l[h]) || "boolean" == typeof k
              ? null : "string" == typeof k || "number" == typeof k
              || "bigint" == typeof k ? v$1(null, k, null, null, k)
                  : Array.isArray(k) ? v$1(y, {children: k}, null, null, null)
                      : k.__b > 0 ? v$1(k.type, k.props, k.key, null, k.__v)
                          : k)) {
        if (k.__ = u, k.__b = u.__b + 1, null === (_ = A[h]) || _ && k.key
        == _.key && k.type === _.type) {
          A[h] = void 0;
        } else {
          for (p = 0;
        ...
        I$1(n, k, _ = _ || r$1, t, o, e, c, s, a), b = k.__e, (p = k.ref)
        && _.ref != p && (w || (w = []), _.ref && w.push(_.ref, null,
            k), w.push(p, k.__c || b, k)), null != b ? (null == m
        && (m = b), "function" == typeof k.type && null != k.__k && k.__k
        === _.__k ? k.__d = s = g$1(k, s, n) : s = x$1(n, k, _, A, b, s), a
        || "option" !== u.type ? "function" == typeof u.type && (u.__d = s)
            : n.value = "") : s && _.__e == s && s.parentNode != n
            && (s = d(_));
      }
    }
    for (u.__e = m, h = P; h--;) {
      null != A[h] && ("function"
      == typeof u.type && null != A[h].__e && A[h].__e == u.__d && (u.__d = d(
          i, h + 1)), L$1(A[h], A[h]));
    }
    if (w) {
  ...
  function g$1(n, l, u) {
    ...
    for (i = 0; i < n.__k.length; i++) {
      (t = n.__k[i])
      && (t.__ = n, l = "function" == typeof t.type ? g$1(t, l, u) : x$1(u, t,
          t, n.__k, t.__e, l));
    }
    return l
  }
  ...
  function x$1(n, l, u, i, t, o) {
    ...
    if (void 0 !== l.__d) {
      r = l.__d, l.__d = void 0;
        ...
        != o || null == t.parentNode) {
      n:if (null == o || o.parentNode
          !== n) {
        n.appendChild(t), r = null;
      } else {
        for (f = o, e = 0; (f = f.nextSibling) && e < i.length;
            e += 2) {
          if (f == t) {
            break n;
          }
  ...
  function A$1(n, l, u, i, t) {
    var o;
    for (o in u) {
      "children" === o || "key" === o || o in l || C$1(n, o,
          null, u[o], i);
    }
    for (o in l) {
      t && "function" != typeof l[o] || "children" === o || "key"
      === o || "value" === o || "checked" === o || u[o] === l[o] || C$1(n, o,
          l[o], u[o], i);
    }
  }

  function P$1(n, l, u) {
    "-" === l[0] ? n.setProperty(l, u) : n[l] = null == u ? "" : "number"
    != typeof u || e$1.test(l) ? u : u + "px";
  }
  ...
  function C$1(n, l, u, i, t) {
    ...
    n:if ("style" === l) {
      ...
      o = l !== (l = l.replace(
          /Capture$/, "")), l = l.toLowerCase() in n ? l.toLowerCase().slice(
          2) : l.slice(2), n.l || (n.l = {}), n.l[l + o] = u, u ? i
          || n.addEventListener(l, o ? H$1 : $$1, o) : n.removeEventListener(
          l, o ? H$1 : $$1, o);
    } else if ("dangerouslySetInnerHTML" !== l) {
      if (t) {
        l = l.replace(/xlink[H:h]/, "h").replace(/sName$/,
            "s");
      } else if ("href" !== l && "list" !== l && "form" !== l
          && "tabIndex" !== l && "download" !== l && l in n) {
        try {
          n[l] = null == u ? "" : u;
          break n
        } catch (n) {
      ...
      "function" == typeof u || (null != u && (!1 !== u || "a" === l[0]
          && "r" === l[1]) ? n.setAttribute(l, u) : n.removeAttribute(l));
    }
  }
  ...
  function I$1(l, u, i, t, o, r, f, e, s) {
    ...
    null != i.__h
    && (s = i.__h, e = u.__e = i.__e, u.__h = null, r = [e]), (a = n.__b)
    && a(u);
    try {
      n:if ("function" == typeof P) {
        if (g = u.props, w = (a = P.contextType) && t[a.__c], x = a ? w
            ? w.props.value : a.__ : t, i.__c
            ? b = (v = u.__c = i.__c).__ = v.__E : ("prototype" in P
            && P.prototype.render ? u.__c = v = new P(g, x)
                : (u.__c = v = new p(g,
                    x), v.constructor = P, v.render = M$1), w && w.sub(
                v), v.props = g, v.state
            || (v.state = {}), v.context = x, v.__n = t, h = v.__d = !0, v.__h = []), null
        == v.__s && (v.__s = v.state), null
        != P.getDerivedStateFromProps && (v.__s == v.state
        && (v.__s = c$1({}, v.__s)), c$1(v.__s,
            P.getDerivedStateFromProps(g,
                v.__s))), d = v.props, _ = v.state, h) {
          null
          == P.getDerivedStateFromProps && null != v.componentWillMount
          && v.componentWillMount(), null != v.componentDidMount
          && v.__h.push(v.componentDidMount);
        } else {
          if (null == P.getDerivedStateFromProps && g !== d && null
          != v.componentWillReceiveProps
          && v.componentWillReceiveProps(g, x), !v.__e && null
          != v.shouldComponentUpdate && !1
          === v.shouldComponentUpdate(g, v.__s, x) || u.__v
          === i.__v) {
            v.props = g, v.state = v.__s, u.__v !== i.__v
            && (v.__d = !1), v.__v = u, u.__e = i.__e, u.__k = i.__k, u.__k.forEach(
                function (n) {
                  n && (n.__ = u);
          ...
          null != v.componentWillUpdate && v.componentWillUpdate(g,
              v.__s, x), null != v.componentDidUpdate && v.__h.push(
              function () {
                v.componentDidUpdate(d, _, k);
              });
        }
        v.context = x, v.props = g, v.state = v.__s, (a = n.__r) && a(
            u), v.__d = !1, v.__v = u, v.__P = l, a = v.render(v.props,
            v.state, v.context), v.state = v.__s, null
        != v.getChildContext && (t = c$1(c$1({}, t),
            v.getChildContext())), h || null
        == v.getSnapshotBeforeUpdate || (k = v.getSnapshotBeforeUpdate(
            d, _)), A = null != a && a.type === y && null == a.key
            ? a.props.children : a, m(l, Array.isArray(A) ? A : [A], u,
            i, t, o, r, f, e,
            s), v.base = u.__e, u.__h = null, v.__h.length && f.push(
            v), b && (v.__E = v.__ = null), v.__e = !1;
      } else {
        null == r && u.__v === i.__v ? (u.__k = i.__k, u.__e = i.__e)
            : u.__e = j$2(i.__e, u, i, t, o, r, f, s);
      }
      (a = n.diffed) && a(u);
    } catch (l) {
      u.__v = null, (s || null != r)
      && (u.__e = e, u.__h = !!s, r[r.indexOf(e)] = null), n.__e(l, u, i);
    }
  }
  ...
  function j$2(n, l, u, i, t, o, e, c) {
    ...
    if ("svg" === _ && (t = !0), null != o) {
      for (; k < o.length;
          k++) {
        if ((a = o[k]) && (a === n || (_ ? a.localName == _ : 3
            == a.nodeType))) {
          n = a, o[k] = null;
          break
        }
    ...
    if (null == n) {
      ...
      n = t ? document.createElementNS("http://www.w3.org/2000/svg", _)
          : document.createElement(_, d.is && d), o = null, c = !1;
    }
    if (null === _) {
      p === d || c && n.data === d || (n.data = d);
    } else {
      if (o = o && f$1.slice.call(n.childNodes), v = (p = u.props
          || r$1).dangerouslySetInnerHTML, h = d.dangerouslySetInnerHTML, !c) {
        if (null != o) {
          for (p = {}, y = 0; y < n.attributes.length;
              y++) {
            p[n.attributes[y].name] = n.attributes[y].value;
          }
        }
        (h || v) && (h && (v && h.__html == v.__html || h.__html
            === n.innerHTML) || (n.innerHTML = h && h.__html || ""));
      }
      if (A$1(n, d, p, t,
          c), h) {
        l.__k = [];
      } else if (k = l.props.children, m(n,
          Array.isArray(k) ? k : [k], l, u, i, t && "foreignObject" !== _,
          o, e, n.firstChild, c), null != o) {
        for (k = o.length; k--;) {
          null
          != o[k] && s(o[k]);
        }
      }
      c || ("value" in d && void 0 !== (k = d.value) && (k !== n.value
          || "progress" === _ && !k) && C$1(n, "value", k, p.value,
          !1), "checked" in d && void 0 !== (k = d.checked) && k
      !== n.checked && C$1(n, "checked", k, p.checked, !1));
    }
    return n
  }
  ...
  function L$1(l, u, i) {
    var t, o, r;
    if (n.unmount && n.unmount(l), (t = l.ref) && (t.current && t.current
        !== l.__e || z(t, null, u)), i || "function" == typeof l.type
    || (i = null != (o = l.__e)), l.__e = l.__d = void 0, null
    != (t = l.__c)) {
  ...
  function N(l, u, i) {
    var t, o, e;
    n.__ && n.__(l, u), o = (t = "function" == typeof i) ? null : i && i.__k
        || u.__k, e = [], I$1(u, l = (!t && i || u).__k = a$1(y, null, [l]),
        o || r$1, r$1, void 0 !== u.ownerSVGElement,
        !t && i ? [i] : o ? null : u.firstChild ? f$1.slice.call(
            u.childNodes) : null, e, !t && i ? i : o ? o.__e : u.firstChild,
        t), T$1(e, l);
  }
  ...
  n = {
    __e: function (n, l) {
      for (var u, i, t; l = l.__;) {
        if ((u = l.__c) && !u.__) {
          try {
            if ((i = u.constructor) && null != i.getDerivedStateFromError
            && (u.setState(i.getDerivedStateFromError(n)), t = u.__d), null
            != u.componentDidCatch && (u.componentDidCatch(
                n), t = u.__d), t) {
              return u.__E = u
            }
          } catch (l) {
    ...
    u = null != this.__s && this.__s !== this.state ? this.__s
        : this.__s = c$1({}, this.state), "function" == typeof n && (n = n(
        c$1({}, u), this.props)), n && c$1(u, n), null != n && this.__v
    && (l && this.__h.push(l), k(this));
  }, p.prototype.forceUpdate = function (n) {
    this.__v && (this.__e = !0, n && this.__h.push(n), k(this));
  }, p.prototype.render = y, u = [], i$1 = "function" == typeof Promise
  ...
  n.__b = function (n) {
    ...
    e && e(t);
    var o = t.__c;
    o && o.__H && o.__H.__h.length && (1 !== i.push(o) && r
        === n.requestAnimationFrame || ((r = n.requestAnimationFrame)
            || function (n) {
              var t, u = function () {
                clearTimeout(r), b && cancelAnimationFrame(
                    t), setTimeout(n);
              }, r = setTimeout(u, 100);
  ...
  (E.prototype = new p).isPureReactComponent = !0, E.prototype.shouldComponentUpdate = function (n,
      t) {
    return S(this.props, n) || S(this.state, t)
  };
  var w = n.__b;
  n.__b = function (n) {
    n.type && n.type.__f && n.ref && (n.props.ref = n.ref, n.ref = null), w
    && w(n);
  };
  var A = n.__e;
    ...
    if (n.then) {
      for (var r, u = t; u = u.__;) {
        if ((r = u.__c)
            && r.__c) {
          return null == t.__e
          && (t.__e = e.__e, t.__k = e.__k), r.__c(n, t);
        }
      }
    }
    A(n, t, e);
      ...
      if (!--r.__u) {
        if (r.state.__e) {
          ...
          r.__v.__k[0] = function n(t, e, r) {
            return t && (t.__v = null, t.__k = t.__k && t.__k.map(
                function (t) {
                  return n(t, e, r)
                }), t.__c && t.__c.__P === e && (t.__e
            && r.insertBefore(t.__e,
                t.__d), t.__c.__e = !0, t.__c.__P = r)), t
    ...
    if (this.__b) {
      if (this.__v.__k) {
        ...
        this.__v.__k[0] = function n(t, e, r) {
          return t && (t.__c && t.__c.__H && (t.__c.__H.__.forEach(
              function (n) {
                "function" == typeof n.__c && n.__c();
              }), t.__c.__H = null), null != (t = C({}, t)).__c
          && (t.__c.__P === r
          && (t.__c.__P = e), t.__c = null), t.__k = t.__k
  ...
  function j(n) {
    ...
    }, t.i && t.i !== e && t.componentWillUnmount(), n.__v ? (t.l
    || (t.i = e, t.l = {
      nodeType: 1,
      parentNode: e,
      childNodes: [],
    ...
    }), N(a$1(T, {context: t.context}, n.__v), t.l)) : t.l
        && t.componentWillUnmount();
  }
  ...
  var W = "undefined" != typeof Symbol && Symbol.for && Symbol.for(
      "react.element") || 60103,
  ...
  p.prototype.isReactComponent = {}, ["componentWillMount",
    "componentWillReceiveProps", "componentWillUpdate"].forEach(
      function (n) {
  ...
  n.event = function (n) {
    return H && (n = H(
        n)), n.persist = Z, n.isPropagationStopped = Y, n.isDefaultPrevented = $, n.nativeEvent = n
  };
  var G = {
    configurable: !0, get: function () {
      return this.class
    ...
    if ("string" == typeof t) {
      for (var u in r = {}, e) {
        ...
        || ("defaultValue" === u && "value" in e && null == e.value
            ? u = "value" : "download" === u && !0 === o ? o = ""
                : /ondoubleclick/i.test(u) ? u = "ondblclick"
                    : /^onchange(textarea|input)/i.test(u + t) && !V(
                        e.type) ? u = "oninput"
                        : /^on(Ani|Tra|Tou|BeforeInp)/.test(u)
                            ? u = u.toLowerCase() : P.test(u)
                                ? u = u.replace(/[A-Z0-9]/,
                                    "-$&").toLowerCase() : null === o
                                && (o = void 0), r[u] = o);
      }
      ...
      })), "select" == t && null != r.defaultValue && (r.value = w$1(
          e.children).forEach(function (n) {
        n.props.selected = r.multiple ? -1 != r.defaultValue.indexOf(
            n.props.value) : r.defaultValue == n.props.value;
      })), n.props = r;
    }
    t && e.class != e.className && (G.enumerable = "className" in e, null
    != e.className && (r.class = e.className), Object.defineProperty(r,
        "className", G)), n.$$typeof = W, J && J(n);
  };
  var K = n.__r;
  n.__r = function (n) {
    K && K(n);
  ...
  "object" == typeof performance && "function" == typeof performance.now
      ? performance.now.bind(performance) : function () {
        return Date.now()
      };
  ...
  function expandRecurring(eventStore, framingRange, context) {
    var dateEnv = context.dateEnv, pluginHooks = context.pluginHooks,
    ...
    for (var defId in defs) {
      ...
      if (def.recurringDef) {
        ...
        var starts = expandRecurringRanges(def, duration, framingRange,
            dateEnv, pluginHooks.recurringTypes);
        for (var _i = 0, starts_1 = starts; _i < starts_1.length;
            _i++) {
  ...
  function parseString(s) {
    ...
    if (m) {
      ...
      return {
        ...
        milliseconds: sign * ((m[3] ? parseInt(m[3], 10) : 0) * 60 * 60
            * 1000 + // hours
  ...
  function isArraysEqual(a0, a1, equalityFunc) {
    ...
    for (i = 0; i < len; i += 1) {
      if (!(equalityFunc ? equalityFunc(a0[i], a1[i]) : a0[i]
          === a1[i])) {
        return false;
      }
    }
  ...
  function memoizeHashlike(// used?
    ...
    return function (newArgHash) {
      ...
      for (var key in newArgHash) {
        ...
        } else if (!isArraysEqual(currentArgHash[key],
            newArgHash[key])) {
          if (teardownFunc) {
  ...
  var NativeFormatter = /** @class */ (function () {
    function NativeFormatter(formatSettings) {
      ...
      for (var name_1 in formatSettings) {
        if (name_1 in EXTENDED_SETTINGS_AND_SEVERITIES) {
          ...
          severity = Math.max(
              EXTENDED_SETTINGS_AND_SEVERITIES[name_1], severity);
        } else {
          standardDateProps[name_1] = formatSettings[name_1];
          if (name_1 in STANDARD_DATE_PROP_SEVERITIES) { // TODO: what about hour12? no severity
            severity = Math.max(
                STANDARD_DATE_PROP_SEVERITIES[name_1], severity);
          }
        }
      }
    ...
    NativeFormatter.prototype.formatRange = function (start, end, context,
      ...
      var _a = this, standardDateProps = _a.standardDateProps,
          extendedSettings = _a.extendedSettings;
      var diffSeverity = computeMarkerDiffSeverity(start.marker,
          end.marker, context.calendarSystem);
      if (!diffSeverity) {
      ...
      var partialDateProps = computePartialFormattingOptions(
          standardDateProps, biggestUnitForPartial);
      var partialFormattingFunc = buildFormattingFunc(partialDateProps,
          extendedSettings, context);
      var partial0 = partialFormattingFunc(start);
      var partial1 = partialFormattingFunc(end);
      var insertion = findCommonInsertion(full0, partial0, full1,
          partial1);
      var separator = extendedSettings.separator || betterDefaultSeparator
    ...
    if (standardDatePropCnt === 0 && extendedSettings.week) {
      return function (date) {
        return (formatWeekNumber(context.computeWeekNumber(date.marker),
            context.weekText, context.locale, extendedSettings.week));
      };
    }
  ...
  function buildNativeFormattingFunc(standardDateProps, extendedSettings,
    ...
    var normalFormat = new Intl.DateTimeFormat(context.locale.codes,
        standardDateProps);
    var zeroFormat; // needed?
    if (extendedSettings.omitZeroMinute) {
      var zeroProps = __assign({}, standardDateProps);
      delete zeroProps.minute; // seconds and ms were already considered in sanitizeSettings
      zeroFormat = new Intl.DateTimeFormat(context.locale.codes,
          zeroProps);
    }
    return function (date) {
      ...
      return postProcess(s, date, standardDateProps, extendedSettings,
          context);
    };
  }
  ...
  function parseEvents(rawEvents, eventSource, context, allowOpenRange) {
    ...
    for (var _i = 0, rawEvents_1 = rawEvents; _i < rawEvents_1.length;
        _i++) {
      var rawEvent = rawEvents_1[_i];
      var tuple = parseEvent(rawEvent, eventSource, context,
          allowOpenRange, eventRefiners);
      if (tuple) {
  ...
  function createEventUi(refined, context) {
    ...
    return {
      ...
      classNames: (refined.className || []).concat(
          refined.classNames || []), // join singular and plural
    };
  }
  ...
  function combineTwoEventUis(item0, item1) {
    return {
      ...
      startEditable: item1.startEditable != null ? item1.startEditable
          : item0.startEditable,
      durationEditable: item1.durationEditable != null
          ? item1.durationEditable : item0.durationEditable,
  ...
  function parseEvent(raw, eventSource, context, allowOpenRange, refiners) {
    ...
    var recurringRes = parseRecurring(refined, defaultAllDay,
        context.dateEnv, context.pluginHooks.recurringTypes);
    if (recurringRes) {
      var def = parseEventDef(refined, extra,
    ...
    var singleRes = parseSingle(refined, defaultAllDay, context,
        allowOpenRange);
    if (singleRes) {
      var def = parseEventDef(refined, extra,
          eventSource ? eventSource.sourceId : '', singleRes.allDay,
          singleRes.hasEnd, context);
      var instance = createEventInstance(def.defId, singleRes.range,
  ...
  function computeAlignedDayRange(timedRange) {
    var dayCnt = Math.floor(diffDays(timedRange.start, timedRange.end))
        || 1;
  ...
  function diffDates(date0, date1, dateEnv, largeUnit) {
    ...
    if (largeUnit === 'month') {
      return createDuration(dateEnv.diffWholeMonths(date0, date1),
          'month');
    }
  ...
  function rangeContainsRange(outerRange, innerRange) {
    return (outerRange.start === null || (innerRange.start !== null
        ...
        (outerRange.end === null || (innerRange.end !== null
  ...
  function buildSegCompareObj(seg) {
    ...
    var range = eventRange.instance ? eventRange.instance.range
        : eventRange.range;
  ...
  function computeSegDraggable(seg, context) {
    ...
    for (var _i = 0, transformers_1 = transformers;
        _i < transformers_1.length; _i++) {
  ...
  function buildSegTimeText(seg, timeFormat, context, defaultDisplayEventTime, // defaults to true
    ...
    var isStartDay = startOfDay(wholeEventStart).valueOf() === startOfDay(
        segStart).valueOf();
    var isEndDay = startOfDay(addMs(wholeEventEnd, -1)).valueOf()
    ...
    if (displayEventTime && !eventDef.allDay && (isStartDay || isEndDay)) {
      ...
      if (displayEventEnd && eventDef.hasEnd) {
        return dateEnv.formatRange(segStart, segEnd, timeFormat, {
          forcedStartTzo: startOverride ? null
              : eventInstance.forcedStartTzo,
          forcedEndTzo: endOverride ? null
  ...
  function getSegMeta(seg, todayRange, nowDate) {
    ...
    return {
      ...
      isToday: todayRange && rangeContainsMarker(todayRange,
          segRange.start),
    };
  }
  ...
  function parseOpenDateSpan(raw, dateEnv) {
    var _a = refineProps(raw, STANDARD_PROPS), standardProps = _a.refined,
        extra = _a.extra;
    var startMeta = standardProps.start ? dateEnv.createMarkerMeta(
  ...
  function triggerDateSelect(selection, pev, context) {
    context.emitter.trigger('select', __assign(
  ...
  function applyMutationToEventStore(eventStore, eventConfigBase, mutation,
    ...
    for (var instanceId in eventStore.instances) {
      ...
      dest.instances[instanceId] = applyMutationToEventInstance(instance,
          def, eventConfigs[instance.defId], mutation, context);
    }
    return dest;
  }
  ...
  function applyMutationToEventDef(eventDef, eventConfig, mutation, context) {
    ...
    if (mutation.extendedProps) {
      copy.extendedProps = __assign(__assign({}, copy.extendedProps),
          mutation.extendedProps);
    }
    for (var _i = 0, _a = context.pluginHooks.eventDefMutationAppliers;
        _i < _a.length; _i++) {
      var applier = _a[_i];
  ...
  function applyMutationToEventInstance(eventInstance, eventDef, // must first be modified by applyMutationToEventDef
    ...
    var clearEnd = mutation.standardProps && mutation.standardProps.hasEnd
        === false;
    ...
    if (clearEnd) {
      copy.range = {
        start: copy.range.start,
        end: getDefaultEventEnd(eventDef.allDay, copy.range.start,
            context),
      };
    }
    ...
    if (copy.range.end < copy.range.start) {
      copy.range.end = getDefaultEventEnd(eventDef.allDay,
          copy.range.start, context);
    }
    return copy;
  }
  ...
  var CalendarApi = /** @class */ (function () {
    ...
    CalendarApi.prototype.select = function (dateOrObj, endDate) {
      ...
      var state = this.getCurrentData();
      var selection = parseDateSpan(selectionInput, state.dateEnv,
    ...
    CalendarApi.prototype.addEvent = function (eventInput, sourceInput) {
        ...
        if (!currentData.eventStore.defs[def.defId]) {
          this.dispatch({
            ...
            eventStore: eventTupleToStore(
                {def: def, instance: instance}), // TODO: better util for two args?
          });
      ...
      if (sourceInput instanceof EventSourceApi) {
        ...
        if (!sourceApi) {
          console.warn("Could not find an event source with ID \""
              + sourceInput + "\""); // TODO: test
          return null;
        }
      ...
      if (tuple) {
        var newEventApi = new EventApi(state, tuple.def,
  ...
  var EventApi = /** @class */ (function () {
    ...
    EventApi.prototype.setEnd = function (endInput, options) {
      ...
      if (this._instance) {
        if (end) {
          var endDelta = diffDates(this._instance.range.end, end,
              dateEnv, options.granularity);
    ...
    EventApi.prototype.setDates = function (startInput, endInput, options) {
      ...
      if (this._instance) {
        ...
        var startDelta = diffDates(instanceRange.start, start, dateEnv,
            options.granularity);
        if (end) {
          var endDelta = diffDates(instanceRange.end, end, dateEnv,
              options.granularity);
    ...
    EventApi.prototype.formatRange = function (formatInput) {
      ...
      if (this._def.hasEnd) {
        return dateEnv.formatRange(instance.range.start,
            instance.range.end, formatter, {
    ...
    EventApi.prototype.mutate = function (mutation) {
      ...
      if (instance) {
        ...
        var relevantEvents = getRelevantEvents(eventStore_1,
            instance.instanceId);
        var eventConfigBase = {
          '': {
            display: '',
        ...
        relevantEvents = applyMutationToEventStore(relevantEvents,
            eventConfigBase, mutation, context_1);
        ...
        context_1.emitter.trigger('eventChange', {
          oldEvent: oldEvent,
          event: this,
          relatedEvents: buildEventApis(relevantEvents, context_1,
              instance),
          revert: function () {
            context_1.dispatch({
              type: 'RESET_EVENTS',
    ...
    Object.defineProperty(EventApi.prototype, "source", {
      get: function () {
        ...
        if (sourceId) {
          return new EventSourceApi(this._context,
    ...
    EventApi.prototype.toPlainObject = function (settings) {
      ...
      if (settings.collapseColor && ui.backgroundColor
  ...
  function parse(str) {
    ...
    if (m) {
      var marker = new Date(
          Date.UTC(Number(m[1]), m[3] ? Number(m[3]) - 1 : 0,
              Number(m[5] || 1), Number(m[7] || 0), Number(m[8] || 0),
              Number(m[10] || 0),
              m[12] ? Number("0." + m[12]) * 1000 : 0));
      if (isValidDate(marker)) {
        var timeZoneOffset = null;
        if (m[13]) {
          timeZoneOffset = (m[15] === '-' ? -1 : 1) * (Number(
              m[16] || 0) * 60 +
              Number(m[18] || 0));
        }
        return {
  ...
  var DateEnv = /** @class */ (function () {
    ...
    DateEnv.prototype.diffWholeYears = function (m0, m1) {
      ...
      if (timeAsMs(m0) === timeAsMs(m1) &&
          calendarSystem.getMarkerDay(m0) === calendarSystem.getMarkerDay(
              m1) &&
      ...
      if (timeAsMs(m0) === timeAsMs(m1) &&
        ...
        return (calendarSystem.getMarkerMonth(m1)
            ...
            (calendarSystem.getMarkerYear(m1)
                - calendarSystem.getMarkerYear(m0)) * 12;
      }
      return null;
    };
    // Range / Duration
    ...
    DateEnv.prototype.formatRange = function (start, end, formatter,
        dateOptions) {
      if (dateOptions === void 0) {
        dateOptions = {};
      }
    ...
    DateEnv.prototype.toDate = function (m, forcedTzo) {
      ...
      return new Date(m.valueOf() -
          this.namedTimeZoneImpl.offsetForArray(dateToUtcArray(m)) * 1000
          * 60);
    };
    return DateEnv;
  }());
  ...
  function organizeRawLocales(explicitRawLocales) {
    var defaultCode = explicitRawLocales.length > 0
        ? explicitRawLocales[0].code : 'en';
    var allRawLocales = globalLocales.concat(explicitRawLocales);
    var rawLocaleMap = {
      en: RAW_EN_LOCALE, // necessary?
    };
    for (var _i = 0, allRawLocales_1 = allRawLocales;
        _i < allRawLocales_1.length; _i++) {
  ...
  function buildLocale(inputSingular, available) {
    if (typeof inputSingular === 'object' && !Array.isArray(
        inputSingular)) {
  ...
  function buildDateEnv$1(settings) {
    var locale = buildLocale(settings.locale || 'en',
  ...
  var Splitter = /** @class */ (function () {
    ...
    Splitter.prototype.splitProps = function (props) {
      ...
      var individualUi = this.splitIndividualUi(props.eventUiBases,
          defKeys); // the individual *bases*
      var eventStores = this.splitEventStore(props.eventStore, defKeys);
      var eventDrags = this.splitEventDrag(props.eventDrag);
      var eventResizes = this.splitEventResize(props.eventResize);
      var splitProps = {};
      this.eventUiBuilders = mapHash(keyInfos, function (info, key) {
        return _this.eventUiBuilders[key] || memoize(
            buildEventUiForKey);
      });
    ...
    Splitter.prototype._splitEventStore = function (eventStore, defKeys) {
      ...
      for (var instanceId in instances) {
        var instance = instances[instanceId];
        for (var _b = 0, _c = defKeys[instance.defId]; _b < _c.length;
            _b++) {
          var key = _c[_b];
    ...
    Splitter.prototype._splitIndividualUi = function (eventUiBases,
        defKeys) {
      var splitHashes = {};
      for (var defId in eventUiBases) {
        if (defId) { // not the '' key
          for (var _i = 0, _a = defKeys[defId]; _i < _a.length;
              _i++) {
            var key = _a[_i];
            if (!splitHashes[key]) {
              splitHashes[key] = {};
    ...
    Splitter.prototype._splitInteraction = function (interaction) {
      ...
      if (interaction) {
        ...
        var mutatedStores_1 = this._splitEventStore(
            interaction.mutatedEvents, mutatedKeysByDefId);
        var populate = function (key) {
          if (!splitStates[key]) {
            splitStates[key] = {
              affectedEvents: affectedStores_1[key]
                  || EMPTY_EVENT_STORE,
              mutatedEvents: mutatedStores_1[key]
                  || EMPTY_EVENT_STORE,
  ...
  function getDateMeta(date, todayRange, nowDate, dateProfile) {
    return {
      dow: date.getUTCDay(),
      isDisabled: Boolean(
          dateProfile && !rangeContainsMarker(dateProfile.activeRange,
          date)),
      isOther: Boolean(
          dateProfile && !rangeContainsMarker(dateProfile.currentRange,
          date)),
      isToday: Boolean(
          todayRange && rangeContainsMarker(todayRange, date)),
      isPast: Boolean(nowDate ? (date < nowDate) : todayRange ? (date
          < todayRange.start) : false),
      isFuture: Boolean(nowDate ? (date > nowDate) : todayRange ? (date
          >= todayRange.end) : false),
    };
  }
  ...
  function computeInnerRect(el, goWithinPadding, doFromWindowViewport) {
    ...
    var outerRect = doFromWindowViewport ? el.getBoundingClientRect()
        : computeRect(el);
    ...
    var res = {
      ...
      bottom: outerRect.bottom - edges.borderBottom
  ...
  function computeClippedClientRect(el) {
    ...
    var rect = el.getBoundingClientRect();
    for (var _i = 0, clippingParents_1 = clippingParents;
        _i < clippingParents_1.length; _i++) {
      var clippingParent = clippingParents_1[_i];
      var intersection = intersectRects(rect,
  ...
  var Emitter = /** @class */ (function () {
    ...
    Emitter.prototype.trigger = function (type) {
      ...
      for (var _a = 0, handlers_1 = handlers; _a < handlers_1.length;
          _a++) {
  ...
  var PureComponent = /** @class */ (function (_super) {
    ...
    PureComponent.prototype.shouldComponentUpdate = function (nextProps,
        nextState) {
      if (this.debug) {
  ...
  var DateComponent = /** @class */ (function (_super) {
    ...
    DateComponent.prototype.queryHit = function (positionLeft, positionTop,
        elWidth, elHeight) {
  ...
  function buildBuildPluginHooks() {
    ...
    return function (overrideDefs, globalDefs) {
      if (!currentHooks || !isArraysEqual(overrideDefs,
          currentOverrideDefs) || !isArraysEqual(globalDefs,
          currentGlobalDefs)) {
  ...
  function combineHooks(hooks0, hooks1) {
    return {
      ...
      eventRefiners: __assign(__assign({}, hooks0.eventRefiners),
      ...
      themeClasses: __assign(__assign({}, hooks0.themeClasses),
          hooks1.themeClasses),
      ...
      listenerRefiners: __assign(__assign({}, hooks0.listenerRefiners),
          hooks1.listenerRefiners),
      optionRefiners: __assign(__assign({}, hooks0.optionRefiners),
          hooks1.optionRefiners),
      propSetHandlers: __assign(__assign({}, hooks0.propSetHandlers),
  ...
  function ensureViewDef(viewType, hash, defaultConfigs, overrideConfigs) {
    ...
    var viewDef = buildViewDef(viewType, hash, defaultConfigs,
        overrideConfigs);
    if (viewDef) {
  ...
  function ContentHook(props) {
    return (createElement(CustomContentRenderContext.Consumer, null,
        function (renderId) {
          return (createElement(ContentHookInner,
  ...
  function buildClassNameNormalizer() {
    ...
    return function (generator, hookProps) {
      if (!currentHookProps || !isPropsEqual(currentHookProps, hookProps)
  ...
  var ViewRoot = /** @class */ (function (_super) {
    ...
    ViewRoot.prototype.render = function () {
      ...
      var customClassNames = this.normalizeClassNames(
          options.viewClassNames, hookProps);
      return (createElement(MountHook, {
        hookProps: hookProps,
  ...
  function createViewHookComponent(options) {
    return function (viewProps) {
      return (createElement(ViewContextType.Consumer, null,
          function (context) {
            return (createElement(ViewRoot,
                ...
                function (viewElRef, viewClassNames) {
                  ...
                  return (createElement(RenderHook, {
                    ...
                    elRef: viewElRef
                  }, function (rootElRef, customClassNames,
                      innerElRef, innerContent) {
                    return (createElement("div", {
                      className: viewClassNames.concat(
  ...
  function buildViewSpecs(defaultInputs, optionOverrides,
    ...
    return mapHash(viewDefs, function (viewDef) {
      return buildViewSpec(viewDef, overrideConfigs, optionOverrides,
          dynamicOptionOverrides, localeDefaults);
    });
  }
  ...
  var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.buildPrev = function (currentDateProfile,
      ...
      var prevDate = dateEnv.subtract(dateEnv.startOf(currentDate,
          currentDateProfile.currentRangeUnit), // important for start-of-month
    ...
    DateProfileGenerator.prototype.buildNext = function (currentDateProfile,
        currentDate, forceToValid) {
      var dateEnv = this.props.dateEnv;
      var nextDate = dateEnv.add(dateEnv.startOf(currentDate,
          currentDateProfile.currentRangeUnit), // important for start-of-month
          currentDateProfile.dateIncrement);
    ...
    DateProfileGenerator.prototype.buildCurrentRangeInfo = function (date,
        direction) {
      var props = this.props;
      var duration = null;
      var unit = null;
      ...
      if (props.duration) {
        ...
        range = this.buildRangeFromDuration(date, direction, duration,
            unit);
      } else if ((dayCount = this.props.dayCount)) {
        unit = 'day';
        range = this.buildRangeFromDayCount(date, direction, dayCount);
      } else if ((range = this.buildCustomVisibleRange(date))) {
        unit = props.dateEnv.greatestWholeUnit(range.start,
            range.end).unit;
      } else {
    ...
    DateProfileGenerator.prototype.adjustActiveRange = function (range) {
      var _a = this.props, dateEnv = _a.dateEnv,
          ...
          slotMinTime = _a.slotMinTime, slotMaxTime = _a.slotMaxTime;
    ...
    DateProfileGenerator.prototype.buildRangeFromDuration = function (date,
    ...
    DateProfileGenerator.prototype.skipHiddenDays = function (date, inc,
        isExclusive) {
      if (inc === void 0) {
        inc = 1;
      }
      ...
      while (this.isHiddenDayHash[(date.getUTCDay() + (isExclusive ? inc
          : 0) + 7) % 7]) {
  ...
  function reduceDynamicOptionOverrides(dynamicOptionOverrides, action) {
    ...
    switch (action.type) {
      case 'SET_OPTION':
        return __assign(__assign({}, dynamicOptionOverrides),
    ...
    switch (action.type) {
      ...
      case 'CHANGE_DATE':
        if (!currentDateProfile.activeRange ||
            !rangeContainsMarker(currentDateProfile.currentRange,
                action.dateMarker) // don't move if date already in view
        ) {
      ...
      case 'PREV':
        ...
        break;
      case 'NEXT':
        dp = dateProfileGenerator.buildNext(currentDateProfile,
            currentDate);
        if (dp.isValid) {
          return dp;
        }
  ...
  function reduceEventSources(eventSources, action, dateProfile, context) {
    ...
    switch (action.type) {
      case 'ADD_EVENT_SOURCES': // already parsed
        return addSources(eventSources, action.sources, activeRange,
            context);
      ...
      case 'CHANGE_VIEW_TYPE':
        if (dateProfile) {
          return fetchDirtySources(eventSources, activeRange,
              context);
        }
        return eventSources;
  ...
  function fetchSourcesByIds(prevSources, sourceIdHash, fetchRange, isRefetch,
    ...
    for (var sourceId in prevSources) {
      ...
      if (sourceIdHash[sourceId]) {
        nextSources[sourceId] = fetchSource(source, fetchRange,
            isRefetch, context);
      } else {
  ...
  function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
    ...
    if (eventSource && // not already removed
      ...
      return __assign(__assign({}, sourceHash),
          (_a = {}, _a[sourceId] = __assign(__assign({}, eventSource),
  ...
  function reduceEventStore(eventStore, action, eventSources, dateProfile,
    ...
    switch (action.type) {
      case 'RECEIVE_EVENTS': // raw
        return receiveRawEvents(eventStore,
            eventSources[action.sourceId], action.fetchId,
            action.fetchRange, action.rawEvents, context);
      ...
      case 'CHANGE_VIEW_TYPE':
        if (dateProfile) {
          return expandRecurring(eventStore, dateProfile.activeRange,
              context);
        }
        return eventStore;
      case 'REMOVE_EVENTS':
      ...
      return __assign(__assign({}, instance), {
        range: {
          start: newDateEnv.createMarker(
              oldDateEnv.toDate(instance.range.start,
                  instance.forcedStartTzo)),
          end: newDateEnv.createMarker(
              oldDateEnv.toDate(instance.range.end,
                  instance.forcedEndTzo)),
        },
        forcedStartTzo: newDateEnv.canComputeOffset ? null
            : instance.forcedStartTzo,
        forcedEndTzo: newDateEnv.canComputeOffset ? null
            : instance.forcedEndTzo
      });
    });
    return {defs: defs, instances: instances};
  ...
  function parseToolbars(calendarOptions, calendarOptionOverrides, theme,
    ...
    var headerToolbar = calendarOptions.headerToolbar ? parseToolbar(
        calendarOptions.headerToolbar, calendarOptions,
        calendarOptionOverrides, theme, viewSpecs, calendarApi,
        viewsWithButtons) : null;
    var footerToolbar = calendarOptions.footerToolbar ? parseToolbar(
        calendarOptions.footerToolbar, calendarOptions,
        calendarOptionOverrides, theme, viewSpecs, calendarApi,
        viewsWithButtons) : null;
    return {
  ...
  function parseToolbar(sectionStrHash, calendarOptions,
    ...
    return mapHash(sectionStrHash, function (sectionStr) {
      return parseSection(sectionStr, calendarOptions,
          calendarOptionOverrides, theme, viewSpecs, calendarApi,
          viewsWithButtons);
    });
  }
        ...
        if ((customButtonProps = calendarCustomButtons[buttonName])) {
          buttonClick = function (ev) {
            if (customButtonProps.click) {
              customButtonProps.click.call(ev.target, ev,
                  ev.target); // TODO: use Calendar this context?
            }
          };
  ...
  function requestJson(method, url, params, successCallback,
      failureCallback) {
  ...
  var eventSourceDef$1 = {
    ...
    fetch: function (arg, success, failure) {
      ...
      var requestParams = buildRequestParams$1(meta, arg.range,
          arg.context);
    ...
    parse: function (refined, dateEnv) {
      if (refined.daysOfWeek || refined.startTime || refined.endTime
        ...
        var recurringData = {
          ...
          endRecur: refined.endRecur ? dateEnv.createMarker(
              refined.endRecur) : null,
        };
        var duration = void 0;
        if (refined.duration) {
        ...
        if (!duration && refined.startTime && refined.endTime) {
          duration = subtractDurations(refined.endTime,
              refined.startTime);
        }
        return {
          allDayGuess: Boolean(
  ...
  function handleEventSources(inputs, context) {
    ...
    for (var _b = 0, newInputs_1 = newInputs; _b < newInputs_1.length;
        _b++) {
  ...
  function handleDateProfile(dateProfile, context) {
    context.emitter.trigger('datesSet', __assign(__assign({},
        buildRangeApiWithTimeZone(dateProfile.activeRange,
            context.dateEnv)), {view: context.viewApi}));
  }
  ...
  function injectDomNodes(el, domNodes) {
    ...
    if (!isArraysEqual(oldNodes, newNodes)) {
      for (var _i = 0, newNodes_1 = newNodes; _i < newNodes_1.length;
          _i++) {
  ...
  var CalendarDataManager = /** @class */ (function () {
    function CalendarDataManager(props) {
      ...
      var currentViewType = optionsData.calendarOptions.initialView
      ...
      var currentDate = getInitialDate(optionsData.calendarOptions,
          optionsData.dateEnv);
      ...
      for (var _i = 0, _a = optionsData.pluginHooks.contextInit;
          _i < _a.length; _i++) {
        var callback = _a[_i];
      ...
      var initialState = {
        ...
        eventDrag: null,
        eventResize: null,
        selectionConfig: this.buildViewUiProps(
    ...
    CalendarDataManager.prototype._handleAction = function (action) {
      ...
      var eventSources = reduceEventSources(state.eventSources, action,
          dateProfile, calendarContext);
      var eventStore = reduceEventStore(state.eventStore, action,
          eventSources, dateProfile, calendarContext);
      var isEventsLoading = computeEventSourcesLoading(eventSources); // BAD. also called in this func in computeIsLoading
      var renderableEventStore = (isEventsLoading
      ...
      var newState = {
        ...
        eventSelection: reduceSelectedEvent(state.eventSelection,
            action),
      ...
      var contextAndState = __assign(__assign({}, calendarContext),
          newState);
      for (var _i = 0, _c = optionsData.pluginHooks.reducers;
          _i < _c.length; _i++) {
        var reducer = _c[_i];
    ...
    CalendarDataManager.prototype.updateData = function () {
      ...
      var data = this.data = __assign(__assign(__assign({
        viewTitle: this.buildTitle(state.dateProfile,
            currentViewData.options, optionsData.dateEnv),
        calendarApi: props.calendarApi,
        dispatch: this.dispatch,
        emitter: this.emitter,
        getCurrentData: this.getCurrentData
      ...
      if (oldCalendarOptions && oldCalendarOptions
          !== newCalendarOptions) {
        ...
        for (var optionName in changeHandlers) {
          if (oldCalendarOptions[optionName]
            ...
            changeHandlers[optionName](
                newCalendarOptions[optionName], data);
          }
        }
      }
      if (props.onData) {
    ...
    CalendarDataManager.prototype._computeOptionsData = function (optionOverrides,
      ...
      var _a = this.processRawCalendarOptions(optionOverrides,
          dynamicOptionOverrides), refinedOptions = _a.refinedOptions,
      ...
      var toolbarConfig = this.parseToolbars(refinedOptions,
          optionOverrides, theme, viewSpecs, calendarApi);
      return {
    ...
    CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides,
      ...
      var pluginHooks = this.buildPluginHooks(
          optionOverrides.plugins || [], globalPlugins);
      var refiners = this.currentCalendarOptionsRefiners = __assign(
          __assign(__assign(__assign(__assign({}, BASE_OPTION_REFINERS),
    ...
    CalendarDataManager.prototype._computeCurrentViewData = function (viewType,
        optionsData, optionOverrides, dynamicOptionOverrides) {
      var viewSpec = optionsData.viewSpecs[viewType];
      if (!viewSpec) {
        throw new Error("viewType \"" + viewType
            + "\" is not available. Please make sure you've loaded all neccessary plugins");
      }
      var _a = this.processRawViewOptions(viewSpec,
          optionsData.pluginHooks, optionsData.localeDefaults,
      ...
      var viewApi = this.buildViewApi(viewType, this.getCurrentData,
          optionsData.dateEnv);
      return {
        viewSpec: viewSpec,
    ...
    CalendarDataManager.prototype.processRawViewOptions = function (viewSpec,
        pluginHooks, localeDefaults, optionOverrides,
        dynamicOptionOverrides) {
      var raw = mergeRawOptions([
        BASE_OPTION_DEFAULTS,
      ...
      var refiners = __assign(__assign(__assign(__assign(
          __assign(__assign({}, BASE_OPTION_REFINERS),
              CALENDAR_LISTENER_REFINERS), CALENDAR_OPTION_REFINERS),
  ...
  function buildDateEnv(timeZone, explicitLocale, weekNumberCalculation,
      firstDay, weekText, pluginHooks, availableLocaleData,
      defaultSeparator) {
  ...
  function computeIsLoading(state, context) {
    for (var _i = 0, _a = context.pluginHooks.isLoadingFuncs;
        _i < _a.length; _i++) {
  ...
  var SegHierarchy = /** @class */ (function () {
    ...
    SegHierarchy.prototype.addSegs = function (segInputs) {
      var hiddenEntries = [];
      for (var _i = 0, segInputs_1 = segInputs; _i < segInputs_1.length;
          _i++) {
    ...
    SegHierarchy.prototype.isInsertionValid = function (insertion, entry) {
      return (this.maxCoord === -1 || insertion.levelCoord
          ...
          (this.maxStackCnt === -1 || insertion.stackCnt
              < this.maxStackCnt);
    };
    SegHierarchy.prototype.handleInvalidInsertion = function (insertion,
        entry, hiddenEntries) {
    ...
    SegHierarchy.prototype.splitEntry = function (entry, barrier,
      ...
      if (entry.spanStart < barrier.spanStart) {
        partCnt += this.insertEntry(__assign(__assign({}, entry),
            {spanStart: entry.spanStart, spanEnd: barrier.spanStart}),
            splitHiddenEntries);
      }
      if (barrier.spanEnd < entry.spanEnd) {
        partCnt += this.insertEntry(__assign(__assign({}, entry),
            {spanStart: barrier.spanEnd, spanEnd: entry.spanEnd}),
            splitHiddenEntries);
      }
      if (partCnt) {
    ...
    SegHierarchy.prototype.insertEntryAt = function (entry, insertion) {
      ...
      // create a new level
      if (!nextLevel || this.levelCoords[nextLevel - 1]
        ...
        insertAt(this.entriesByLevel[nextLevel - 1],
            insertion.lateralEnd, entry);
      }
      this.stackCnts[buildEntryKey(entry)] = insertion.stackCnt;
    };
    SegHierarchy.prototype.findInsertion = function (newEntry) {
      var _a = this, levelCoords = _a.levelCoords,
          entriesByLevel = _a.entriesByLevel, stackCnts = _a.stackCnts,
      ...
      for (level = 0; level < levelCnt; level += 1) {
        ...
        if (!strictOrder && levelCoord >= resCoord
            + newEntry.thickness) {
          break;
        }
        var entries = entriesByLevel[level];
        var entry = void 0;
        var searchRes = binarySearch(entries, newEntry.spanStart,
            getEntrySpanEnd);
      ...
      return {
        ...
        stackCnt: touchingEntry ? stackCnts[buildEntryKey(
            touchingEntry)] + 1 : 0,
      };
    };
    // sorted by levelCoord (lowest to highest)
    SegHierarchy.prototype.toRects = function () {
      var _a = this, entriesByLevel = _a.entriesByLevel,
      ...
      for (var level = 0; level < levelCnt; level += 1) {
        ...
        for (var _i = 0, entries_1 = entries; _i < entries_1.length;
            _i++) {
  ...
  function groupIntersectingEntries(entries) {
    ...
    for (var _i = 0, entries_2 = entries; _i < entries_2.length; _i++) {
      ...
      for (var _a = 0, merges_1 = merges; _a < merges_1.length; _a++) {
        ...
        if (merge.spanStart < hungryMerge.spanEnd && merge.spanEnd
            > hungryMerge.spanStart) { // collides?
          hungryMerge = {
            spanStart: Math.min(merge.spanStart,
                hungryMerge.spanStart),
  ...
  function parseDragMeta(raw) {
    var _a = refineProps(raw, DRAG_META_REFINERS), refined = _a.refined,
        extra = _a.extra;
    return {
      startTime: refined.startTime || null,
  ...
  var ToolbarSection = /** @class */ (function (_super) {
    ...
    ToolbarSection.prototype.render = function () {
      ...
      return createElement.apply(void 0,
          __spreadArray(['div', {className: 'fc-toolbar-chunk'}],
              children));
    };
    ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
      ...
      for (var _i = 0, widgetGroup_1 = widgetGroup;
          _i < widgetGroup_1.length; _i++) {
        ...
        if (buttonName === 'title') {
          isOnlyButtons = false;
          children.push(
              createElement("h2", {className: "fc-toolbar-title"},
                  props.title));
        } else {
          ...
          var isDisabled = (!props.isTodayEnabled && buttonName
              === 'today') ||
      ...
      if (children.length > 1) {
        var groupClassName = (isOnlyButtons && theme.getClass(
            'buttonGroup')) || '';
        return createElement.apply(void 0,
            __spreadArray(['div', {className: groupClassName}],
                children));
      }
      return children[0];
    };
  ...
  var Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.render = function () {
      var _a = this.props, model = _a.model,
      ...
      _this.handleSegClick = function (ev, segEl) {
        ...
        if (seg && // might be the <div> surrounding the more link
          ...
          var hasUrlContainer = elementClosest(ev.target,
              '.fc-event-forced-url');
          var url = hasUrlContainer ? hasUrlContainer.querySelector(
              'a[href]').href : '';
          context.emitter.trigger('eventClick', {
            el: segEl,
            event: new EventApi(component.context,
  ...
  var EventHovering = /** @class */ (function (_super) {
    ...
    EventHovering.prototype.triggerEvent = function (publicEvName, ev,
        segEl) {
      ...
      if (!ev || component.isValidSegDownEl(ev.target)) {
        context.emitter.trigger(publicEvName, {
          el: segEl,
          event: new EventApi(context, seg.eventRange.def,
  ...
  var CalendarContent = /** @class */ (function (_super) {
    ...
    function CalendarContent() {
      ...
      _this.handleNavLinkClick = buildDelegationHandler('a[data-navlink]',
      ...
      // -----------------------------------------------------------------------------------------------------------------
      _this.registerInteractiveComponent = function (component,
          settingsInput) {
        var settings = parseInteractionSettings(component,
            settingsInput);
    ...
    CalendarContent.prototype.render = function () {
      ...
      var toolbarProps = this.buildToolbarProps(props.viewSpec,
          props.dateProfile, props.dateProfileGenerator,
      ...
      var viewContext = this.buildViewContext(props.viewSpec,
          props.viewApi, props.options, props.dateProfileGenerator,
          props.dateEnv, props.theme, props.pluginHooks, props.dispatch,
          props.getCurrentData, props.emitter, props.calendarApi,
    ...
    CalendarContent.prototype.componentWillUnmount = function () {
      ...
      for (var _i = 0, _a = this.calendarInteractions; _i < _a.length;
          _i++) {
    ...
    CalendarContent.prototype._handleNavLinkClick = function (ev,
        anchorEl) {
  ...
  var CalendarRoot = /** @class */ (function (_super) {
    ...
    CalendarRoot.prototype.render = function () {
      ...
      var isHeightAuto = forPrint || options.height === 'auto'
          || options.contentHeight === 'auto';
      var height = (!isHeightAuto && options.height != null)
          ? options.height : '';
      var classNames = [
        'fc',
  ...
  var TableDateCell = /** @class */ (function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      var _a = this.context, dateEnv = _a.dateEnv, options = _a.options,
          theme = _a.theme, viewApi = _a.viewApi;
      var props = this.props;
      var date = props.date, dateProfile = props.dateProfile;
      var dayMeta = getDateMeta(date, props.todayRange, null,
          dateProfile);
      var classNames = [CLASS_NAME].concat(
          getDayClassNames(dayMeta, theme));
      var text = dateEnv.format(date, props.dayHeaderFormat);
      // if colCnt is 1, we are already in a day-view and don't need a navlink
      var navLinkAttrs = (options.navLinks && !dayMeta.isDisabled
          && props.colCnt > 1)
      ...
      }, function (rootElRef, customClassNames, innerElRef,
          innerContent) {
        return (createElement("th", __assign({
              ref: rootElRef,
              className: classNames.concat(customClassNames).join(' '),
              "data-date": !dayMeta.isDisabled ? formatDayString(date)
                  : undefined,
  ...
  var TableDowCell = /** @class */ (function (_super) {
    ...
    TableDowCell.prototype.render = function () {
      ...
      var _a = this.context, dateEnv = _a.dateEnv, theme = _a.theme,
          viewApi = _a.viewApi, options = _a.options;
      ...
      var classNames = [CLASS_NAME].concat(
          getDayClassNames(dateMeta, theme), props.extraClassNames || []);
      var text = dateEnv.format(date, props.dayHeaderFormat);
      var hookProps = __assign(__assign(__assign(__assign({ // TODO: make this public?
            date: date
          }, dateMeta), {view: viewApi}), props.extraHookProps),
          {text: text});
      return (createElement(RenderHook, {
        hookProps: hookProps,
        classNames: options.dayHeaderClassNames,
  ...
  var NowTimer = /** @class */ (function (_super) {
    ...
    NowTimer.prototype.computeTiming = function () {
      var _a = this, props = _a.props, context = _a.context;
      var unroundedNow = addMs(this.initialNowDate,
    ...
    NowTimer.prototype.setTimeout = function () {
      var _this = this;
      var _a = this.computeTiming(), nextState = _a.nextState,
          waitMs = _a.waitMs;
  ...
  var DayHeader = /** @class */ (function (_super) {
    ...
    DayHeader.prototype.render = function () {
      ...
      var dayHeaderFormat = this.createDayHeaderFormatter(
          context.options.dayHeaderFormat, datesRepDistinctDays,
          dates.length);
      return (createElement(NowTimer, {unit: "day"},
          function (nowDate, todayRange) {
            return (createElement("tr", null,
                renderIntro && renderIntro('day'),
                dates.map(function (date) {
                  return (datesRepDistinctDays ? (createElement(
                      TableDateCell, {
  ...
  function createDayHeaderFormatter(explicitFormat, datesRepDistinctDays,
      dateCnt) {
    return explicitFormat || computeFallbackHeaderFormat(
  ...
  var DayTableModel = /** @class */ (function () {
    function DayTableModel(daySeries, breakOnWeeks) {
      ...
      if (breakOnWeeks) {
        ...
        for (daysPerRow = 1; daysPerRow < dates.length;
            daysPerRow += 1) {
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype.sliceProps = function (props, dateProfile,
      ...
      var eventSegs = this.sliceEventStore.apply(this, __spreadArray(
          [props.eventStore, eventUiBases, dateProfile, nextDayThreshold],
          extraArgs));
      return {
        dateSelectionSegs: this.sliceDateSelection.apply(this,
            __spreadArray([props.dateSelection, eventUiBases, context],
                extraArgs)),
        businessHourSegs: this.sliceBusinessHours.apply(this,
            __spreadArray(
                [props.businessHours, dateProfile, nextDayThreshold,
                  context], extraArgs)),
        fgEventSegs: eventSegs.fg,
        bgEventSegs: eventSegs.bg,
        eventDrag: this.sliceEventDrag.apply(this, __spreadArray(
            [props.eventDrag, eventUiBases, dateProfile,
              nextDayThreshold], extraArgs)),
        eventResize: this.sliceEventResize.apply(this, __spreadArray(
            [props.eventResize, eventUiBases, dateProfile,
              nextDayThreshold], extraArgs)),
        eventSelection: props.eventSelection,
    ...
    Slicer.prototype._sliceBusinessHours = function (businessHours,
    ...
    Slicer.prototype._sliceEventStore = function (eventStore, eventUiBases,
        dateProfile, nextDayThreshold) {
      var extraArgs = [];
      for (var _i = 4; _i < arguments.length; _i++) {
        extraArgs[_i - 4] = arguments[_i];
      }
      if (eventStore) {
        var rangeRes = sliceEventStore(eventStore, eventUiBases,
            computeActiveRange(dateProfile, Boolean(nextDayThreshold)),
            nextDayThreshold);
        return {
    ...
    Slicer.prototype._sliceDateSpan = function (dateSpan, eventUiBases,
        context) {
      var extraArgs = [];
      ...
      var eventRange = fabricateEventRange(dateSpan, eventUiBases,
          context);
      var segs = this.sliceRange.apply(this,
    ...
    Slicer.prototype.sliceEventRanges = function (eventRanges, extraArgs) {
      var segs = [];
      for (var _i = 0, eventRanges_1 = eventRanges;
          _i < eventRanges_1.length; _i++) {
  ...
  function isNewPropsValid(newProps, context) {
    ...
    return (context.pluginHooks.isPropsValid || isPropsValid)(props,
        context);
  }
  ...
  // ------------------------------------------------------------------------------------------------------------------------
  function isInteractionPropsValid(state, context, dateSpanMeta,
      filterConfig) {
    ...
    var otherEventStore = excludeInstances(state.eventStore,
    ...
    for (var subjectInstanceId in subjectInstances) {
      ...
      var eventOverlapFunc = typeof eventOverlap === 'function'
          ? eventOverlap : null;
      for (var otherInstanceId in otherInstances) {
        ...
        if (rangesIntersect(subjectRange, otherInstance.range)) {
          ...
          if (eventOverlapFunc && !eventOverlapFunc(
              new EventApi(context, otherDefs[otherInstance.defId],
  ...
  function isDateSelectionPropsValid(state, context, dateSpanMeta,
    ...
    var selectOverlapFunc = typeof selectOverlap === 'function'
        ? selectOverlap : null;
    for (var relevantInstanceId in relevantInstances) {
      ...
      if (rangesIntersect(selectionRange, relevantInstance.range)) {
        ...
        if (selectOverlapFunc && !selectOverlapFunc(
            new EventApi(context, relevantDefs[relevantInstance.defId],
    ...
    for (var _i = 0, _a = selectionConfig.allows; _i < _a.length; _i++) {
      ...
      if (!selectionAllow(
          buildDateSpanApiWithContext(fullDateSpan, context), null)) {
        return false;
      }
    }
    return true;
  ...
  function constraintToRanges(constraint, subjectRange, // for expanding a recurring constraint, or expanding business hours
    ...
    if (constraint === 'businessHours') {
      return eventStoreToRanges(
          expandRecurring(businessHoursUnexpanded, subjectRange,
              context));
    }
  ...
  function anyRangesContainRange(outerRanges, innerRange) {
    for (var _i = 0, outerRanges_1 = outerRanges; _i < outerRanges_1.length;
        _i++) {
        ...
        createElement('table', {
          ...
          style: {
            ...
            typeof chunkConfig.rowContent === 'function'
                ? chunkConfig.rowContent(arg) : chunkConfig.rowContent));
    return content;
  }
    ...
    for (var _i = 0, cols_1 = cols; _i < cols_1.length; _i++) {
      ...
      for (var i = 0; i < span; i += 1) {
        colNodes.push(createElement("col", {
          style: {
            width: colProps.width === 'shrink'
                ? sanitizeShrinkWidth(shrinkWidth) : (colProps.width
                    || ''),
  ...
  function getStickyFooterScrollbar(options) {
    ...
    if (stickyFooterScrollbar == null || stickyFooterScrollbar === 'auto') {
      stickyFooterScrollbar = options.height === 'auto'
          || options.viewHeight === 'auto';
    }
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    function SimpleScrollGrid() {
      ...
      _this.handleSizing = function () {
        _this.setState(
            __assign({shrinkWidth: _this.computeShrinkWidth()},
    ...
    SimpleScrollGrid.prototype.render = function () {
      ...
      var microColGroupNode = this.renderMicroColGroup(cols,
          state.shrinkWidth);
      ...
      return createElement('table', {
          ...
          isBuggy && createElement.apply(void 0, __spreadArray(
          __spreadArray(__spreadArray(['tbody', {}], headSectionNodes),
              bodySectionNodes), footSectionNodes)));
    };
    SimpleScrollGrid.prototype.renderSection = function (sectionConfig,
        microColGroupNode) {
      if ('outerContent' in sectionConfig) {
        return (createElement(Fragment, {key: sectionConfig.key},
            sectionConfig.outerContent));
      }
      return (createElement("tr", {
        key: sectionConfig.key,
        className: getSectionClassNames(sectionConfig,
            this.props.liquid).join(' ')
    ...
    SimpleScrollGrid.prototype._handleScrollerEl = function (scrollerEl,
        key) {
    ...
    SimpleScrollGrid.prototype.computeScrollerDims = function () {
      ...
      var _a = this, scrollerRefs = _a.scrollerRefs,
  ...
  var EventRoot = /** @class */ (function (_super) {
    ...
    EventRoot.prototype.render = function () {
      ...
      var hookProps = {
        event: new EventApi(context, eventRange.def,
            eventRange.instance),
        view: context.viewApi,
        ...
        isMirror: Boolean(props.isDragging || props.isResizing
      ...
      return (createElement(RenderHook, {
        ...
        elRef: this.elRef
          ...
          innerContent) {
        return props.children(rootElRef,
            standardClassNames.concat(customClassNames), innerElRef,
            innerContent, hookProps);
      }));
    };
  ...
  var StandardEvent = /** @class */ (function (_super) {
    ...
    StandardEvent.prototype.render = function () {
      ...
      var timeFormat = context.options.eventTimeFormat
          || props.defaultTimeFormat;
      var timeText = buildSegTimeText(seg, timeFormat, context,
  ...
  function refineDayCellHookProps(raw) {
    ...
    return __assign(__assign(
        ...
        {
          dayNumberText: raw.showDayNumber ? dateEnv.format(date,
              DAY_NUM_FORMAT) : ''
        }), raw.extraProps);
  }
  ...
  var DayCellRoot = /** @class */ (function (_super) {
    ...
    DayCellRoot.prototype.render = function () {
      ...
      return (createElement(MountHook, {
        ...
        return props.children(rootElRef, classNames, dataAttrs,
            hookProps.isDisabled);
      }));
    };
    return DayCellRoot;
  ...
  function renderInnerContent$3(props) {
    ...
    return title && (createElement("div", {className: "fc-event-title"},
        props.event.title));
  }
  ...
  var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
      ...
      return createPortal(createElement("div",
          ...
          createElement("div", {
                className: 'fc-popover-header ' + theme.getClass(
                    'popoverHeader')
              },
              createElement("span", {className: "fc-popover-title"},
                  props.title),
              createElement("span", {
                className: 'fc-popover-close ' + theme.getIconClass(
                    'close'), onClick: this.handleCloseClick
              })),
          createElement("div", {
            className: 'fc-popover-body ' + theme.getClass(
                'popoverContent')
    ...
    Popover.prototype.updateSize = function () {
      ...
      if (alignmentRect) {
        ...
        var popoverTop = alignGridTop
            ...
            : alignmentRect.top;
        var popoverLeft = isRtl ? alignmentRect.right
            - popoverDims.width : alignmentRect.left;
        // constrain
  ...
  var MorePopover = /** @class */ (function (_super) {
    ...
    MorePopover.prototype.render = function () {
      ...
      var props = this.props;
      var startDate = props.startDate, todayRange = props.todayRange,
          dateProfile = props.dateProfile;
  ...
  var MoreLinkRoot = /** @class */ (function (_super) {
    ...
    function MoreLinkRoot() {
      ...
      _this.handleClick = function (ev) {
        ...
        function buildPublicSeg(seg) {
          var _a = seg.eventRange, def = _a.def,
              instance = _a.instance, range = _a.range;
          return {
    ...
    MoreLinkRoot.prototype.render = function () {
      ...
      return (createElement(ViewContextType.Consumer, null,
          function (context) {
            var viewApi = context.viewApi, options = context.options,
    ...
    MoreLinkRoot.prototype.updateParentEl = function () {
      if (this.linkElRef.current) {
        this.parentEl = elementClosest(this.linkElRef.current,
            '.fc-view-harness');
      }
    };
    return MoreLinkRoot;
  ...
  function pickLatestEnd(seg0, seg1) {
    return seg0.eventRange.range.end > seg1.eventRange.range.end ? seg0
        : seg1;
  }
  ...
  var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype.setClassNames = function (classNames) {
      if (!isArraysEqual(classNames, this.currentClassNames)) {
        ...
        for (var _i = 0, _a = this.currentClassNames; _i < _a.length;
            _i++) {
          var className = _a[_i];
  ...
  var PointerDragging = /** @class */ (function () {
    function PointerDragging(containerEl) {
      ...
      this.handleTouchStart = function (ev) {
        if (_this.tryStart(ev)) {
          ...
          window.addEventListener('scroll', _this.handleTouchScroll,
              true);
        }
      };
      ...
      this.handleScroll = function (ev) {
        if (!_this.shouldIgnoreMove) {
          var pageX = (window.pageXOffset - _this.prevScrollX)
              + _this.prevPageX;
          var pageY = (window.pageYOffset - _this.prevScrollY)
              + _this.prevPageY;
    ...
    // Event Normalization
    // ----------------------------------------------------------------------------------------------------
    PointerDragging.prototype.createEventFromMouse = function (ev,
        isFirst) {
      var deltaX = 0;
      var deltaY = 0;
      // TODO: repeat code
    ...
    PointerDragging.prototype.createEventFromTouch = function (ev,
        isFirst) {
  ...
  var ElementMirror = /** @class */ (function () {
    ...
    ElementMirror.prototype.doRevertAnimation = function (callback,
        revertDuration) {
    ...
    ScrollGeomCache.prototype.setScrollLeft = function (top) {
      ...
      if (!this.doesListening) {
        ...
        this.scrollLeft = Math.max(
            Math.min(top, this.getMaxScrollLeft()), 0);
        this.handleScrollChange();
      }
    };
  ...
  var ElementScrollGeomCache = /** @class */ (function (_super) {
    ...
    function ElementScrollGeomCache(el, doesListening) {
      return _super.call(this, new ElementScrollController(el),
          doesListening) || this;
    }
  ...
  var WindowScrollGeomCache = /** @class */ (function (_super) {
    ...
    function WindowScrollGeomCache(doesListening) {
      return _super.call(this, new WindowScrollController(),
          doesListening) || this;
    }
  ...
  var getTime = typeof performance === 'function' ? performance.now
      : Date.now;
  /*
  ...
  var AutoScroller = /** @class */ (function () {
    ...
    AutoScroller.prototype.handleMove = function (pageX, pageY) {
      if (this.isEnabled) {
        ...
        var yDelta = this.pointerScreenY === null ? 0 : pointerScreenY
            - this.pointerScreenY;
    ...
    AutoScroller.prototype.computeBestEdge = function (left, top) {
      ...
      for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
        ...
        if (leftDist >= 0 && rightDist >= 0 && topDist >= 0
            && bottomDist >= 0) {
    ...
    AutoScroller.prototype.queryScrollEls = function () {
      ...
      for (var _i = 0, _a = this.scrollQuery; _i < _a.length; _i++) {
        ...
        if (typeof query === 'object') {
          ...
          els.push.apply(els, Array.prototype.slice.call(
  ...
  var OffsetTracker = /** @class */ (function () {
    ...
    OffsetTracker.prototype.computeLeft = function () {
      ...
      for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
        var scrollCache = _a[_i];
        left += scrollCache.origScrollLeft
            - scrollCache.getScrollLeft();
      }
      return left;
    };
  ...
  var HitDragging = /** @class */ (function () {
    ...
    HitDragging.prototype.queryHitForOffset = function (offsetLeft,
        offsetTop) {
      ...
      for (var id in droppableStore) {
        ...
        if (offsetTracker && // wasn't destroyed mid-drag
          ...
          if (
            ...
            var hit = component.queryHit(positionLeft, positionTop,
                width, height);
            if (hit && (
  ...
  function buildDatePointApiWithContext(dateSpan, context) {
    var props = {};
    for (var _i = 0, _a = context.pluginHooks.datePointTransforms;
        _i < _a.length; _i++) {
      var transform = _a[_i];
      __assign(props, transform(dateSpan, context));
    }
  ...
  var DateClicking = /** @class */ (function (_super) {
    ...
    function DateClicking(settings) {
      ...
      _this.handleDragEnd = function (ev) {
        ...
        if (!pointer.wasTouchScroll) {
          ...
          if (initialHit && finalHit && isHitsEqual(initialHit,
              finalHit)) {
            var context = component.context;
            var arg = __assign(__assign({},
                buildDatePointApiWithContext(initialHit.dateSpan,
                    context)), {
      ...
      var hitDragging = _this.hitDragging = new HitDragging(
          _this.dragging, interactionSettingsToStore(settings));
  ...
  var DateSelecting = /** @class */ (function (_super) {
    ...
    function DateSelecting(settings) {
      ...
      _this.handlePointerDown = function (ev) {
        var _a = _this, component = _a.component,
        ...
        dragging.delay = ev.isTouch ? getComponentTouchDelay$1(
            component) : null;
      };
      ...
      _this.handleHitUpdate = function (hit, isFinal) {
        ...
        if (dragSelection) {
          context.dispatch(
              {type: 'SELECT_DATES', selection: dragSelection});
      ...
      _this.handlePointerUp = function (pev) {
        if (_this.dragSelection) {
          ...
          triggerDateSelect(_this.dragSelection, pev,
  ...
  function joinHitsIntoSelection(hit0, hit1, dateSelectionTransformers) {
    ...
    var props = {};
    for (var _i = 0,
        dateSelectionTransformers_1 = dateSelectionTransformers;
        _i < dateSelectionTransformers_1.length; _i++) {
    ...
    function EventDragging(settings) {
      ...
      _this.handleDragStart = function (ev) {
        ...
        if (_this.isDragging) {
          ...
          initialContext.emitter.trigger('eventDragStart', {
            el: _this.subjectEl,
            event: new EventApi(initialContext, eventRange.def,
                eventRange.instance),
            jsEvent: ev.origEvent,
      ...
      _this.handleDragEnd = function (ev) {
        if (_this.isDragging) {
          ...
          var _a = _this, receivingContext_1 = _a.receivingContext,
              validMutation = _a.validMutation;
          var eventDef = _this.eventRange.def;
          var eventInstance = _this.eventRange.instance;
          var eventApi = new EventApi(initialContext_1, eventDef,
              eventInstance);
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              var eventChangeArg = {
                ...
                relatedEvents: buildEventApis(
                    mutatedRelevantEvents_1, initialContext_1,
                    eventInstance),
                revert: function () {
                  initialContext_1.dispatch({
                    type: 'MERGE_EVENTS',
              ...
              initialContext_1.emitter.trigger('eventDrop',
                  __assign(__assign(__assign({}, eventChangeArg),
                      transformed), {
                    el: ev.subjectEl,
              ...
              initialContext_1.emitter.trigger('eventChange',
                  eventChangeArg);
              // dropped in different calendar
            } else if (receivingContext_1) {
              var eventRemoveArg = {
                event: eventApi,
                relatedEvents: buildEventApis(relevantEvents_1,
              ...
              var eventAddArg = {
                event: addedEventApi,
                relatedEvents: buildEventApis(
                    mutatedRelevantEvents_1, receivingContext_1,
                    addedEventInstance),
                revert: function () {
                  receivingContext_1.dispatch({
                    type: 'REMOVE_EVENTS',
              ...
              receivingContext_1.emitter.trigger('drop', __assign(
                  __assign({}, buildDatePointApiWithContext(
                      finalHit.dateSpan, receivingContext_1)), {
                    draggedEl: ev.subjectEl,
                    jsEvent: ev.origEvent,
      ...
      dragging.autoScroller.isEnabled = options.dragScroll;
      var hitDragging = _this.hitDragging = new HitDragging(
          _this.dragging, interactionSettingsStore);
  ...
  function computeEventMutation(hit0, hit1, massagers) {
    ...
    var delta = diffDates(date0, date1, hit0.context.dateEnv,
    ...
    for (var _i = 0, massagers_1 = massagers; _i < massagers_1.length;
        _i++) {
          ...
          if (!disallowed) {
            mutation = computeMutation(initialHit, hit,
                ev.subjectEl.classList.contains(
                    'fc-event-resizer-start'), eventInstance.range);
          }
        }
        if (mutation) {
          mutatedRelevantEvents = applyMutationToEventStore(
              relevantEvents, context.getCurrentData().eventUiBases,
              mutation, context);
          interaction.mutatedEvents = mutatedRelevantEvents;
        ...
        if (_this.validMutation) {
          ...
          context.emitter.trigger('eventResize',
              __assign(__assign({}, eventChangeArg), {
                el: _this.draggingSegEl,
                startDelta: _this.validMutation.startDelta
                    || createDuration(0),
                endDelta: _this.validMutation.endDelta
                    || createDuration(0),
                jsEvent: ev.origEvent,
                view: context.viewApi
              }));
  ...
  var UnselectAuto = /** @class */ (function () {
    function UnselectAuto(context) {
      ...
      this.onDocumentPointerDown = function (pev) {
        ...
        _this.matchesEvent = !!elementClosest(downEl,
  ...
  var ExternalElementDragging = /** @class */ (function () {
    function ExternalElementDragging(dragging, suppliedDragMeta) {
      ...
      this.handleDragEnd = function (pev) {
        ...
        if (receivingContext && droppableEvent) {
          ...
          receivingContext.emitter.trigger('drop', __assign(
              __assign({},
          ...
          if (dragMeta.create) {
            ...
            receivingContext.emitter.trigger('eventReceive', {
              event: new EventApi(receivingContext,
      ...
      var hitDragging = this.hitDragging = new HitDragging(dragging,
    ...
    ExternalElementDragging.prototype.displayDrag = function (nextContext,
        state) {
      var prevContext = this.receivingContext;
      if (prevContext && prevContext !== nextContext) {
        prevContext.dispatch({type: 'UNSET_EVENT_DRAG'});
    ...
    ExternalElementDragging.prototype.canDropElOnCalendar = function (el,
        receivingContext) {
  ...
  var ExternalDraggable = /** @class */ (function () {
    function ExternalDraggable(el, settings) {
      ...
      this.handlePointerDown = function (ev) {
        var dragging = _this.dragging;
        var _a = _this.settings, minDistance = _a.minDistance,
      ...
      this.handleDragStart = function (ev) {
        if (ev.isTouch &&
          ...
          _this.dragging.mirror.getMirrorEl().classList.add(
              'fc-event-selected');
        }
      };
  ...
  var TableView = /** @class */ (function (_super) {
    ...
    TableView.prototype.renderHScrollLayout = function (headerRowContent,
      ...
      var _a = this, props = _a.props, context = _a.context;
      var stickyHeaderDates = !props.forPrint && getStickyHeaderDates(
          context.options);
      var stickyFooterScrollbar = !props.forPrint
          && getStickyFooterScrollbar(context.options);
      var sections = [];
      if (headerRowContent) {
        sections.push({
          type: 'header',
    ...
    TableCellTop.prototype.render = function () {
      ...
      return (createElement(DayCellContent, {
        ...
        return ((innerContent || props.forceDayTop) && (createElement(
            ...
            createElement("a",
                __assign({className: "fc-daygrid-day-number"},
                    navLinkAttrs),
  ...
  var TableBlockEvent = /** @class */ (function (_super) {
    ...
    TableBlockEvent.prototype.render = function () {
      ...
      return (createElement(StandardEvent, __assign({}, props, {
        extraClassNames: ['fc-daygrid-event', 'fc-daygrid-block-event',
          'fc-h-event'],
  ...
  var TableListItemEvent = /** @class */ (function (_super) {
    ...
    TableListItemEvent.prototype.render = function () {
      ...
      var timeText = buildSegTimeText(props.seg, timeFormat, context,
          true, props.defaultDisplayEventEnd);
      return (createElement(EventRoot, {
        seg: props.seg,
        timeText: timeText,
        ...
        return ( // we don't use styles!
            createElement("a", __assign({
              className: ['fc-daygrid-event',
                'fc-daygrid-dot-event'].concat(classNames).join(
                  ' '), ref: rootElRef
  ...
  function renderInnerContent$2(innerProps) {
    return (createElement(Fragment, null,
        createElement("div", {
          ...
          style: {
            borderColor: innerProps.borderColor
  ...
  function compileSegs(singlePlacements) {
    var allSegs = [];
    var invisibleSegs = [];
    for (var _i = 0, singlePlacements_1 = singlePlacements;
        _i < singlePlacements_1.length; _i++) {
      ...
      return (createElement(DayCellRoot, {
        ...
        return (createElement("td", __assign({
            ...
            createElement("div", {
                ...
                function (weekElRef, weekClassNames, innerElRef,
                    innerContent) {
                  return (createElement("a", __assign({
                    ref: weekElRef,
  ...
  function computeFgSegPlacement(segs, // assumed already sorted
      dayMaxEvents, dayMaxEventRows, strictOrder, eventInstanceHeights,
      maxContentHeight, cells) {
    ...
    for (var _b = 0, hiddenEntries_1 = hiddenEntries;
        _b < hiddenEntries_1.length; _b++) {
      ...
      for (var col = hiddenEntry.spanStart; col < hiddenEntry.spanEnd;
          col += 1) {
        moreCnts[col] += 1;
        singleColPlacements[col].push({
          seg: resliceSeg(seg, col, col + 1, cells),
        ...
        if (isAbsolute) {
          ...
          if (isFirstCol) {
            multiPlacements.push({
              seg: resliceSeg(seg, rect.spanStart, rect.spanEnd,
                  cells),
              isVisible: true,
              isAbsolute: true,
  ...
  function resliceSeg(seg, spanStart, spanEnd, cells) {
    ...
    return __assign(__assign({}, seg), {
      ...
      isEnd: seg.isEnd && slicedRange.end.valueOf()
  ...
  var DayGridSegHierarchy = /** @class */ (function (_super) {
    ...
    DayGridSegHierarchy.prototype.addSegs = function (segInputs) {
      ...
      for (var level = 0; level < entriesByLevel.length; level += 1) {
        entriesByLevel[level] = entriesByLevel[level].filter(
            excludeHidden);
      }
      return hiddenSegs;
    };
    DayGridSegHierarchy.prototype.handleInvalidInsertion = function (insertion,
        entry, hiddenEntries) {
      var _a = this, entriesByLevel = _a.entriesByLevel,
          forceHidden = _a.forceHidden;
      var level = insertion.nextLevel - 1;
      if (this.hiddenConsumes && level >= 0) {
        for (var lateral = insertion.lateralStart;
            lateral < insertion.lateralEnd; lateral += 1) {
          var leadingEntry = entriesByLevel[level][lateral];
          if (this.allowReslicing) {
            var placeholderEntry = __assign(
                __assign({}, leadingEntry), {
                  spanStart: Math.max(leadingEntry.spanStart,
                      entry.spanStart),
                  spanEnd: Math.min(leadingEntry.spanEnd,
                      entry.spanEnd)
                });
            var placeholderEntryId = buildEntryKey(
                placeholderEntry);
      ...
      return _super.prototype.handleInvalidInsertion.call(this, insertion,
          entry, hiddenEntries);
    };
  ...
  var TableRow = /** @class */ (function (_super) {
    ...
    TableRow.prototype.render = function () {
      ...
      var businessHoursByCol = splitSegsByFirstCol(props.businessHourSegs,
          colCnt);
      var bgEventSegsByCol = splitSegsByFirstCol(props.bgEventSegs,
          colCnt);
      var highlightSegsByCol = splitSegsByFirstCol(
          this.getHighlightSegs(), colCnt);
      var mirrorSegsByCol = splitSegsByFirstCol(this.getMirrorSegs(),
          colCnt);
      var _b = computeFgSegPlacement(
          sortEventSegs(props.fgEventSegs, options.eventOrder),
          props.dayMaxEvents, props.dayMaxEventRows,
          options.eventOrderStrict, state.eventInstanceHeights,
          state.maxContentHeight, props.cells),
      ...
      return (createElement("tr", {ref: this.rootElRef},
          ...
          props.cells.map(function (cell, col) {
            ...
            var mirrorFgNodes = _this.renderFgSegs(col,
                buildMirrorPlacements(mirrorSegsByCol[col],
                    multiColPlacements), props.todayRange, {},
                Boolean(props.eventDrag), Boolean(props.eventResize),
                false);
    ...
    TableRow.prototype.componentDidUpdate = function (prevProps,
        prevState) {
    ...
    TableRow.prototype.renderFgSegs = function (col, segPlacements,
        todayRange, isForcedInvisible, isDragging, isResizing,
        isDateSelecting) {
      var context = this.context;
      ...
      var nodes = [];
      if (framePositions) {
        for (var _i = 0, segPlacements_1 = segPlacements;
            _i < segPlacements_1.length; _i++) {
          var placement = segPlacements_1[_i];
          var seg = placement.seg;
          var instanceId = seg.eventRange.instance.instanceId;
          var key = instanceId + ':' + col;
          var isVisible = placement.isVisible
              && !isForcedInvisible[instanceId];
      ...
      if (!props.forPrint &&
        ...
        if (isExternalSizingChange) {
          ...
          if (frameEls.length) {
            ...
            this.setState({
              framePositions: new PositionCache(originEl,
                  frameEls, true, // isHorizontal
                  false),
            });
          }
        }
        var limitByContentHeight = props.dayMaxEvents === true
    ...
    TableRow.prototype.queryEventInstanceHeights = function () {
      ...
      for (var key in segElMap) {
        ...
        eventInstanceHeights[instanceId] = Math.max(
            eventInstanceHeights[instanceId] || 0, height);
      }
  ...
  function buildAbsoluteTopHash(colPlacements) {
    ...
    for (var _i = 0, colPlacements_1 = colPlacements;
        _i < colPlacements_1.length; _i++) {
  ...
  var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.queryHit = function (positionLeft, positionTop) {
      var _a = this, colPositions = _a.colPositions,
  ...
  var DayTable = /** @class */ (function (_super) {
    ...
    DayTable.prototype.render = function () {
      var _a = this, props = _a.props, context = _a.context;
      return (createElement(Table, __assign({ref: this.tableRef},
  ...
  var DayTableView = /** @class */ (function (_super) {
    ...
    DayTableView.prototype.render = function () {
      var _this = this;
      var _a = this.context, options = _a.options,
  ...
  function buildDayTableModel(dateProfile, dateProfileGenerator) {
    var daySeries = new DaySeriesModel(dateProfile.renderRange,
        dateProfileGenerator);
  ...
  var TableDateProfileGenerator = /** @class */ (function (_super) {
    ...
    TableDateProfileGenerator.prototype.buildRenderRange = function (currentRange,
        currentRangeUnit, isRangeAllDay) {
      var dateEnv = this.props.dateEnv;
  ...
  var TimeColsView = /** @class */ (function (_super) {
    ...
    function TimeColsView() {
      ...
      _this.renderHeadAxis = function (rowKey, frameHeight) {
        ...
        if (options.weekNumbers && rowKey === 'day') {
          ...
          }, function (rootElRef, classNames, innerElRef,
              innerContent) {
    ...
    TimeColsView.prototype.renderHScrollLayout = function (headerRowContent,
        allDayContent, timeContent, colCnt, dayMinWidth, slatMetas,
        slatCoords) {
      var _this = this;
      var ScrollGrid = this.context.pluginHooks.scrollGridImpl;
      if (!ScrollGrid) {
    ...
    TimeColsView.prototype.getAllDayMaxEventProps = function () {
      var _a = this.context.options, dayMaxEvents = _a.dayMaxEvents,
  ...
  var TimeColsSlatsCoords = /** @class */ (function () {
    ...
    TimeColsSlatsCoords.prototype.computeDateTop = function (when,
        startOfDayDate) {
      if (!startOfDayDate) {
    ...
    TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
      var _a = this, positions = _a.positions,
          dateProfile = _a.dateProfile;
      var len = positions.els.length;
      // floating-point value of # of slots covered
      var slatCoverage = (duration.milliseconds - asRoughMs(
      ...
      return (createElement("tbody", null,
          props.slatMetas.map(function (slatMeta, i) {
            ...
            return (createElement("tr", {
                ...
                props.axis && (createElement(TimeColsAxisCell,
                __assign({}, slatMeta))),
                createElement(RenderHook, {
                  hookProps: hookProps,
        ...
        if (rootEl.offsetHeight) { // not hidden by css
          props.onCoords(new TimeColsSlatsCoords(
              new PositionCache(this.rootElRef.current,
                  collectSlatEls(this.slatElRefs.currentMap,
                      props.slatMetas), false, true),
              this.props.dateProfile, context.options.slotDuration));
        }
      }
    };
    ...
    TimeColMoreLink.prototype.render = function () {
      ...
      return (createElement(MoreLinkRoot, {
        ...
        return (createElement("a", {
              ...
              className: ['fc-timegrid-more-link'].concat(
                  classNames).join(' '),
  ...
  function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
    ...
    for (; level < levelCnt && levelCoords[level] < afterSubject;
        level += 1) {
      ;
    } // do nothing
    for (; level < levelCnt; level += 1) {
      var entries = entriesByLevel[level];
      var entry = void 0;
      var searchIndex = binarySearch(entries, subjectEntry.spanStart,
          getEntrySpanEnd);
  ...
  function stretchWeb(topLevelNodes, totalThickness) {
    var stretchNode = cacheable(function (node, startCoord, prevThickness) {
      ...
      if (!nextLevelNodes.length) {
        ...
        for (var _i = 0, nextLevelNodes_1 = nextLevelNodes;
            _i < nextLevelNodes_1.length; _i++) {
          var childNode = nextLevelNodes_1[_i];
          if (endCoord === undefined) {
            var res = stretchNode(childNode, startCoord,
                allThickness);
            endCoord = res[0];
    ...
    function processNodes(nodes, levelCoord, stackDepth) {
      ...
      for (var _i = 0, nodes_1 = nodes; _i < nodes_1.length; _i++) {
        ...
        stackForward = Math.max(
            processNode(node, levelCoord, stackDepth), stackForward);
      }
      return stackForward;
    }
  ...
  var TimeCol = /** @class */ (function (_super) {
    ...
    TimeCol.prototype.renderFgSegs = function (sortedFgSegs, segIsInvisible,
    ...
    TimeCol.prototype.renderPositionedFgSegs = function (segs, // if not mirror, needs to be sorted
      ...
      var _this = this;
      var _a = this.context.options, eventMaxStack = _a.eventMaxStack,
          eventShortHeight = _a.eventShortHeight,
          eventOrderStrict = _a.eventOrderStrict;
      var _b = this.props, eventSelection = _b.eventSelection,
      ...
      var _c = isMirror ? computeFgSegPlacements(segInputs) : // don't use memoized
          this.computeFgSegPlacements(segInputs, eventOrderStrict,
              eventMaxStack), segRects = _c.segRects,
      ...
      return (createElement(Fragment, null,
          ...
          segRects.map(function (segRect) {
            ...
            var instanceId = seg.eventRange.instance.instanceId;
            var positionCss = __assign(__assign({},
                _this.computeSegTopBottomCss(segRect.segInput)),
                (isMirror ? {left: 0, right: 0}
                    : _this.computeSegLeftRightCss(segRect)));
            return (createElement("div", {
                  className: 'fc-timegrid-event-harness'
                      + (segRect.stackForward > 0
                ...
                createElement(TimeColEvent, __assign({
                  ...
                  isDateSelecting: isDateSelecting,
                  isSelected: instanceId === eventSelection,
                  isShort: (segRect.spanEnd - segRect.spanStart)
                      < eventShortHeight
    ...
    TimeCol.prototype.renderHiddenGroups = function (hiddenGroups, segs) {
      var _this = this;
      var _a = this.props, extraDateSpan = _a.extraDateSpan,
          dateProfile = _a.dateProfile, todayRange = _a.todayRange,
          nowDate = _a.nowDate, eventSelection = _a.eventSelection,
      ...
      return (createElement(Fragment, null,
          hiddenGroups.map(function (hiddenGroup) {
            ...
            var hiddenSegs = compileSegsFromEntries(hiddenGroup.entries,
                segs);
    ...
    TimeCol.prototype.renderNowIndicator = function (segs) {
      ...
      return segs.map(function (seg, i) {
        return (createElement(NowIndicatorRoot, {
          ...
          return (createElement("div", {
            ref: rootElRef,
            className: ['fc-timegrid-now-indicator-line'].concat(
                classNames).join(' '),
  ...
  function renderPlainFgSegs(sortedFgSegs, _a) {
    var todayRange = _a.todayRange, nowDate = _a.nowDate,
        eventSelection = _a.eventSelection, eventDrag = _a.eventDrag,
  ...
  var TimeCols = /** @class */ (function (_super) {
    ...
    TimeCols.prototype.queryHit = function (positionLeft, positionTop) {
      ...
      var _b = this.processSlotOptions(this.props.slotDuration,
          options.snapDuration), snapDuration = _b.snapDuration,
      ...
      if (colIndex != null && slatIndex != null) {
        ...
        var time = addDurations(dateProfile.slotMinTime,
      ...
      for (var col = 0; col < dayRanges.length; col += 1) {
        ...
        if (segRange) {
          segs.push({
            ...
            isStart: segRange.start.valueOf()
                === range.start.valueOf(),
  ...
  var DayTimeCols = /** @class */ (function (_super) {
    ...
    DayTimeCols.prototype.render = function () {
      ...
      var isNowIndicator = context.options.nowIndicator;
      var dayRanges = this.buildDayRanges(dayTableModel, dateProfile,
          context.dateEnv);
          ...
          function (nowDate, todayRange) {
            return (createElement(TimeCols,
                __assign({ref: _this.timeColsRef},
                    _this.slicer.sliceProps(props, dateProfile, null,
                        context, dayRanges), {
                      forPrint: props.forPrint,
                      axis: props.axis,
                      dateProfile: dateProfile,
                      ...
                      expandRows: props.expandRows,
                      nowDate: nowDate,
                      nowIndicatorSegs: isNowIndicator
                          && _this.slicer.sliceNowDate(nowDate,
                              context, dayRanges),
                      todayRange: todayRange,
  ...
  function buildSlatMetas(slotMinTime, slotMaxTime, explicitLabelInterval,
    ...
    var labelInterval = explicitLabelInterval || computeLabelInterval(
        slotDuration);
    var metas = [];
    while (asRoughMs(slatTime) < asRoughMs(slotMaxTime)) {
      var date = dateEnv.add(dayStart, slatTime);
      var isLabeled = wholeDivideDurations(slatIterator, labelInterval)
          !== null;
      metas.push({
        date: date,
        time: slatTime,
  ...
  var DayTimeColsView = /** @class */ (function (_super) {
    ...
    DayTimeColsView.prototype.render = function () {
      ...
      var props = this.props;
      var dateProfile = props.dateProfile;
      var dayTableModel = this.buildTimeColsModel(dateProfile,
          dateProfileGenerator);
      ...
      return hasDetachedAxis
          ? this.renderHScrollLayout(headerContent, allDayContent,
              timeGridContent, dayTableModel.colCnt, dayMinWidth,
              slatMetas, this.state.slatCoords)
  ...
  var ListViewHeaderRow = /** @class */ (function (_super) {
    ...
    ListViewHeaderRow.prototype.render = function () {
      var _a = this.props, dayDate = _a.dayDate,
          todayRange = _a.todayRange;
      var _b = this.context, theme = _b.theme, dateEnv = _b.dateEnv,
          options = _b.options, viewApi = _b.viewApi;
      var dayMeta = getDateMeta(dayDate, todayRange);
      // will ever be falsy?
      var text = options.listDayFormat ? dateEnv.format(dayDate,
          options.listDayFormat) : '';
      // will ever be falsy? also, BAD NAME "alt"
      var sideText = options.listDaySideFormat ? dateEnv.format(dayDate,
  ...
  function renderInnerContent(props) {
    ...
    return (createElement(Fragment, null,
        ...
        props.text)),
        props.sideText && (createElement("a",
    ...
    if (options.displayEventTime !== false) {
      ...
      if (doAllDay) {
        ...
        return (createElement(RenderHook, {
          ...
          return (createElement("td", {
            className: ['fc-list-event-time'].concat(
                classNames).join(' '), ref: rootElRef
          }, innerContent));
        }));
      }
      return (createElement("td", {className: "fc-list-event-time"},
          timeText));
    }
    return null;
  }
  ...
  var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.render = function () {
      ...
      var eventSegs = this.eventStoreToSegs(props.eventStore,
          ...
          function (rootElRef, classNames) {
            return (createElement("div", {
                ...
                createElement(Scroller, {
                  ...
                  overflowX: props.isHeightAuto ? 'visible'
                      : 'hidden',
    ...
    ListView.prototype.renderSegList = function (allSegs, dayDates) {
      ...
      return (createElement(NowTimer, {unit: "day"},
          function (nowDate, todayRange) {
            var innerNodes = [];
            for (var dayIndex = 0; dayIndex < segsByDay.length;
                dayIndex += 1) {
              ...
              if (daySegs) { // sparse array, so might be undefined
                ...
                daySegs = sortEventSegs(daySegs,
                    options.eventOrder);
                for (var _i = 0, daySegs_1 = daySegs;
                    _i < daySegs_1.length; _i++) {
    ...
    ListView.prototype._eventStoreToSegs = function (eventStore,
        eventUiBases, dayRanges) {
      return this.eventRangesToSegs(
          sliceEventStore(eventStore, eventUiBases,
              this.props.dateProfile.activeRange,
              this.context.options.nextDayThreshold).fg, dayRanges);
    };
    ListView.prototype.eventRangesToSegs = function (eventRanges,
        dayRanges) {
      var segs = [];
      for (var _i = 0, eventRanges_1 = eventRanges;
          _i < eventRanges_1.length; _i++) {
      ...
      for (dayIndex = 0; dayIndex < dayRanges.length; dayIndex += 1) {
        ...
        if (segRange) {
          ...
          if (!seg.isEnd && !allDay &&
              ...
              range.end <
              dateEnv.add(dayRanges[dayIndex + 1].start,
                  nextDayThreshold)) {
            seg.end = range.end;
            seg.isEnd = true;
            break;
  ...
  var eventSourceDef = {
    ...
    fetch: function (arg, onSuccess, onFailure) {
      ...
      if (!apiKey) {
        ...
        var extraParamsObj = typeof extraParams === 'function'
            ? extraParams() : extraParams;
        var requestParams_1 = buildRequestParams(arg.range, apiKey,
  ...
  globalPlugins.push(interactionPlugin, dayGridPlugin, timeGridPlugin,
      listPlugin, plugin, googleCalendarPlugin);
