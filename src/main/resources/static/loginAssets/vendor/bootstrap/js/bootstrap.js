  ...
  var Dropdown = function ($) {
    ...
    var Dropdown = function () {
      ...
      Dropdown.prototype._getConfig = function _getConfig(config) {
        ...
        config = $.extend({}, this.constructor.Default, $(this._element).data(),
            config);
      ...
      Dropdown.prototype._getPlacement = function _getPlacement() {
        ...
        // Handle dropup
        if ($parentDropdown.hasClass(ClassName.DROPUP) || this._config.placement
            === AttachmentMap.TOP) {
      ...
      Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(event) {
        if (!REGEXP_KEYDOWN.test(event.which) || /button/i.test(
            event.target.tagName) && event.which === SPACE_KEYCODE
        ...
        if (!isActive && (event.which !== ESCAPE_KEYCODE || event.which
            !== SPACE_KEYCODE) || isActive && (event.which === ESCAPE_KEYCODE
    ...
    var Modal = function () {
      ...
      Modal.prototype._enforceFocus = function _enforceFocus() {
        ...
        .on(Event.FOCUSIN, function (event) {
          if (document !== event.target && _this13._element !== event.target
      ...
      Modal.prototype._resetScrollbar = function _resetScrollbar() {
        ...
        $(Selector.FIXED_CONTENT).each(function (index, element) {
          ...
          if (typeof padding !== 'undefined') {
            $(element).css('padding-right', padding).removeData(
                'padding-right');
          }
        });
  ...
  var Tab = function ($) {
    ...
    var Tab = function () {
      ...
      Tab.prototype._activate = function _activate(element, container,
        ...
        var complete = function complete() {
          return _this23._transitionComplete(element, active, isTransitioning,
              callback);
        };
      ...
      Tooltip.prototype._setListeners = function _setListeners() {
        ...
        triggers.forEach(function (trigger) {
          if (trigger === 'click') {
            ...
            $(_this26.element).on(eventIn, _this26.config.selector,
                function (event) {
